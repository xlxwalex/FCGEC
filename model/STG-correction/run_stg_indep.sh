...
OUTPUT_PATH=stg_indep_test.xlsx

# STEP 1 - PREPROCESS DATASET
DATA_BASE_DIR=dataset
DATA_OUT_DIR=stg_indep
...
# STEP 2 - TRAIN STG-Indep MODEL
# -- Switch Module --
SWITCH_CHECK_DIR=switch_module
python indep_switch.py --mode train \
--gpu_id ${CUDA_ID} \
--seed ${SEED} \
...
# -- Tagger Module --
TAGGER_CHECK_DIR=tagger_module
python indep_tagger.py --mode train \
--gpu_id ${CUDA_ID} \
--seed ${SEED} \
--checkpoints ${CHECKPOINT_DIR} \
...
# -- Generator Module --
GEN_CHECK_DIR=generator_module
...
# STEP 3 - Predict Test Output STG-Indep MODEL
python indep_evaluate.py --mode test --gpu_id ${CUDA_ID} --seed ${SEED} \
