...
def parse_args():
    ...
    base_args.add_arg('checkp_switch', str, 'switch_module/', 'Checkpoint Sub Dir (Switch)')
    base_args.add_arg('checkp_tagger', str, 'tagger_module/', 'Checkpoint Sub Dir (Tagger)')
    base_args.add_arg('checkp_gen', str, 'generator_module/', 'Checkpoint Sub Dir (Generator)')

    base_args.add_arg('export', str, 'stg_indep_test.csv', 'Export file name')
    base_args.add_arg('is_tti', bool,False, 'Indep-TTi Flag')
