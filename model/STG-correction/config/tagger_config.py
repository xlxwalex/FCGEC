...
def parse_args():
    ...
    base_args.add_arg('checkp', str, 'tagger_module/', 'Checkpoint Sub Dir')
    ...
    model_args.add_arg('tagger_classes', int, 7, 'Number of Tagger Classes')
    ...
    model_args.add_arg('ignore_val', int, -1, 'Padding Value Of ignore (tagger) index')
    ...
    train_args.add_arg('print_step', int, 100, 'Training Print Steps')
    train_args.add_arg('eval_step', int, 500, 'Evaluating Steps')
