...
import torch
# Import Dataset
from DataProcessor import TaggerDatasetTTI as TaggerDataset
# Import utils
from utils import get_device, set_seed, collate_fn_tagger_V2TTI as collate_fn, TAGGER_MAP, tagger_loss_weights
# Import Trainer
from Trainer import TaggerTrainerTTI as TaggerTrainer
# Import Model
from Model import TaggerModelTTI as TaggerModel
from transformers import AdamW

def train(args, check_dirname = ""):
    print('=' * 20 + 'Train Tagger+TTI Module' + '=' * 20)
    # Checkpoint
    ...
    criterion = (criterion_tagger, criterion_insmod, criterion_tti)
